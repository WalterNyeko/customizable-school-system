...
public class LaboratorySciencePractical extends JPanel {
	...
	public LaboratorySciencePractical() {
		buildGUI();
	}
	...
	private void buildGUI() {
		...
		btnAddItem.addActionListener(new ActionListener() {
			...
			LaboratoryScienceAddEditDialog addEditDialog=new LaboratoryScienceAddEditDialog();
		...
		btnAddEditItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (row < 0) {
					JOptionPane.showMessageDialog(LaboratorySciencePractical.this, "You must select an item from Items Table",
		...
		btnNewEvents.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				laboratoryICTRecordEvent.displayInComboBox(laboratoryICTRecordEvent.fieldItemName,
						"select item_name from laboratory_science_items");
				laboratoryICTRecordEvent.displayInComboBox(laboratoryICTRecordEvent.fieldType,
						"select item_type from laboratory_science_items");
		...
		btnEditEvents.addActionListener(new ActionListener() {
			...
			private LaboratorySciencePracticalRecordEvent laboratoryScienceEditEvent;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (row < 0) {
					JOptionPane.showMessageDialog(LaboratorySciencePractical.this, "You must select an event from Events Table",
							"Error", JOptionPane.ERROR_MESSAGE);
					return;
				} else {
					laboratoryScienceEditEvent=new LaboratorySciencePracticalRecordEvent();
					...
					laboratoryScienceEditEvent.fieldItemName.setSelectedItem(name);
					laboratoryScienceEditEvent.fieldType.setSelectedItem(type);
					laboratoryScienceEditEvent.fieldIDNo.setText(code);
					laboratoryScienceEditEvent.fieldResponsiblePerson.setText(person);
					laboratoryScienceEditEvent.areaDescription.setText(desc);
					laboratoryScienceEditEvent.chooser.setDate(date);
					laboratoryScienceEditEvent.setTitle("Edit Selected Event");
					laboratoryScienceEditEvent.getBtnAddEvent().setPreferredSize(new Dimension(120, 30));
					laboratoryScienceEditEvent.getBtnAddEvent().setText("Save Changes");
		...
		btnEvents.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				displayData(tableEvents,
						"select item_name,item_type,event_date,item_description,responsible_person,student_code,student_class from laboratory_science_events");
			}
		});
		...
		displayData(tableEvents,
				"select item_name,item_type,event_date,item_description,responsible_person,student_code from laboratory_science_events");
	...
	public LaboratoryICTRecordEvent getLaboratoryICTRecordEvent() {
		return laboratoryICTRecordEvent;
	}

	public void setLaboratoryICTRecordEvent(LaboratoryICTRecordEvent laboratoryICTRecordEvent) {
		this.laboratoryICTRecordEvent = laboratoryICTRecordEvent;
	}

	public LaboratorySciencePractical getLaboratorySciencePractical() {
		return laboratorySciencePractical;
	}

	public void setLaboratorySciencePractical(LaboratorySciencePractical laboratorySciencePractical) {
		this.laboratorySciencePractical = laboratorySciencePractical;
	}
	...
	public void setScrollPaneEvents(JScrollPane scrollPaneEvents) {
		this.scrollPaneEvents = scrollPaneEvents;
	}
