...
public class LaboratorySciencePracticalRecordEvent extends JDialog {
	...
	public LaboratorySciencePracticalRecordEvent() {
	...
	private void softEarth() {
		...
		displayInComboBox(fieldItemName, "select item_name from laboratory_science_items");
		fieldItemName.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				displayInComboBox(fieldType, "select item_type from laboratory_science_items where item_name='"+fieldItemName.getSelectedItem()+"'");
				displayInTextArea(areaDescription, "select item_description from laboratory_science_items where item_name='"+fieldItemName.getSelectedItem()+"'");
			}
		});
		...
		displayInComboBox(fieldType, "select item_type from laboratory_science_items");
		...
		btnAddEvent.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(btnAddEvent.getText().equals("Add")) {
				AddUpdateDelete("insert into laboratory_science_events(item_name,item_type,responsible_person,student_code,item_description,event_date) "
				...
				displayData(laboratoryICT.tableEvents, "select item_name,item_type,event_date,item_description,responsible_person,student_code,student_class from laboratory_science_events");
				}else {
