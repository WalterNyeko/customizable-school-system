...
public class NonTeachingStaffsPopup extends JFrame {
	...
	public JTextField fieldTIN;

	public JTextField fieldNSSF;

	public static void main(String[] args) {
		new NonTeachingStaffsPopup();
	}

	public NonTeachingStaffsPopup() {
		...
		labelTeachingNSSF = new JLabel("Post");
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (btnSave.getText().equalsIgnoreCase("Save")) {
					AddUpdateDelete("insert into table_non_teaching_staffs values(" + "'" + fieldIDNo.getText() + "','"
					...
					AddUpdateDelete("insert into non_teaching_staff(staff_id,staff_name,responsibility) values(" + "'"
							+ fieldIDNo.getText() + "','" + fieldName.getText() + "'," + "'Non Teaching Staff')");
					closing();

				} else if (btnSave.getText().equalsIgnoreCase("Save Changes")) {
					AddUpdateDelete("update table_non_teaching_staffs set id_number='" + fieldIDNo.getText() + "',"
...
public void displayStaffsInfo(){
		...
		try {
			...
			PreparedStatement pst = conn.prepareStatement(
					"select * from table_non_teaching_staffs where id_number='" + staffID + "'");
