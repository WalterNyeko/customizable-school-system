...
public class VisitationDay extends JDialog{
	...
	JTextField fiStuName,fiStuClass,fiStuID,fiVisitorName,fiIDNo,fiAddress;
	JComboBox fiRship;
	JTextField fiVisitorContact;
	JComboBox fiIDtype;
	JButton btnSave;
	...
	public VisitationDay() {
		...
		labelstudentName.setPreferredSize(new Dimension(150, 25));
		...
		labelStudentID.setPreferredSize(new Dimension(150, 25));
		...
		labelVisitorsName.setPreferredSize(new Dimension(150, 25));
		...
		labelContact.setPreferredSize(new Dimension(150, 25));
		...
		labelIDType.setPreferredSize(new Dimension(150, 25));
		labelIDType.setForeground(Color.WHITE);
		
		fiIDtype=new JComboBox(new String [] {"Student ID","National ID","Residence ID","Passport","Driving Permit","Staff ID","Others"});
		...
		labelIDNo.setPreferredSize(new Dimension(150, 25));
		...
		labelAddress.setPreferredSize(new Dimension(150, 25));
		...
		labelRship.setPreferredSize(new Dimension(150, 25));
		labelRship.setForeground(Color.WHITE);
		
		fiRship=new JComboBox(new String [] {"Father","Mother","Aunt","Uncle","Cousin","Nephew","Brother","Sister","Friend","Others"});
		panelhome.add(fiRship);
		fiRship.setPreferredSize(new Dimension(200, 25));
		
		labelTerm=new JLabel("Term:");
		labelTerm.setFont(new Font("Times New Roman", Font.BOLD, 15));
		panelhome.add(labelTerm);
		labelTerm.setPreferredSize(new Dimension(150, 25));
		labelTerm.setForeground(Color.WHITE);
		...
		btnSave=new JButton("Save VD Record");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					myPreparedStatement = myConnection.prepareStatement("insert into visitation"
							...
							+ "visitor_id_type, visitor_id_number, visitor_address, visitor_student_relationship,term)"
							+ "VALUES("
							+ "'"+fiStuName.getText()+"', '"+fiStuClass.getText()+"', '"+fiStuID.getText()+"', '"+fiVisitorName.getText()+"', '"+fiVisitorContact.getText()+"',"
							+ "'"+fiIDtype.getSelectedItem()+"', '"+fiIDNo.getText()+"', '"+fiAddress.getText()+"', '"+fiRship.getSelectedItem()+"','"+combo.getSelectedItem()+"'"
							+ ")");
