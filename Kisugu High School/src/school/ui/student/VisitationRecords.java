...
public class VisitationRecords extends JDialog {
	...
	public static void main(String[] args) {
		...
		new VisitationRecords();
	}

	public VisitationRecords() {
		...
		String[] headingS1 = new String[] { "Student ID Number", "Student Name", "Visitor's Name", "Contacts", "Address",
				"Student Class" };
