...
public class AddNewPrefect extends JFrame {
	...
	public AddNewPrefect() {
		...
		fieldID.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent arg0) {
				...
				String sqlStatement = "Select first_name,middle_name,last_name,class_joining,gender from tableadmissionstudentdetails where id_number='"
						+ fieldID.getText() + "'";
		...
		btnsafe.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				PrefectsController controller = null;
				try {
					controller = new PrefectsController();
				...
				Prefects prefects = new Prefects(id, firstName, middleName, lastName, studentClass, gender, year, post);

				try {
					controller.addPrefect(prefects);
				...
				AddNewPrefect.this.setVisible(false);
