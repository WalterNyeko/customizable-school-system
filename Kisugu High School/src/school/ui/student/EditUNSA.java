...
public class EditUNSA extends JFrame {
	...
	public EditUNSA() {
		...
		btnsafe.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				AddUpdateDelete("update UNSA set first_name='" + firstName + "'," + "middle_name='" + middleName
						+ "', last_name='" + lastName + "',student_class='" + studentClass + "'," + "gender='" + gender
						+ "',year_of_regime='" + year + "',post='" + post + "' where id_number='" + id + "'");
