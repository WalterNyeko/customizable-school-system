...
public class Club {
	...
	public Club(int id, String idNumber, String firstName, String middleName, String lastName, String studentClass,
	...
	public Club(int id, String idNumber, String firstName, String middleName, String lastName, String studentClass,
			String gender, String yearOfRegime) {
		super();
		this.id = id;
		this.idNumber = new SimpleStringProperty(idNumber);
		this.firstName = new SimpleStringProperty(firstName);
	...
	public Club(String idNumber, String firstName, String middleName, String lastName, String studentClass,
			String gender, String yearOfRegime, String post) {
		super();
		this.idNumber = new SimpleStringProperty(idNumber);
		this.firstName = new SimpleStringProperty(firstName);
