...
public class PrefectsDAO {

	

	Connection myConnection = null;

	public PrefectsDAO() throws SQLException {
		myConnection =  CashBookController.getConnection();
	}

	public void addNewPrefect(Prefects prefects) throws SQLException {
		PreparedStatement myPreparedStatement = null;
		try {
			myPreparedStatement = myConnection
					.prepareStatement("insert into prefects(" + "id, id_number, first_name, middle_name, last_name, "
